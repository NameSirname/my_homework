...
class Window(QMainWindow):
 ...
 ###       
        self.const_re = QLineEdit('1.0',self)
        grid.addWidget(self.const_re,1,0,1,2)

        self.const_im = QLineEdit('0.0',self)
...
###
        self.a = QLineEdit('-2',self)
        grid.addWidget(self.a,10,0,1,1)

        self.c = QLineEdit('1',self)
